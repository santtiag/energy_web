const h2 = 'flex items-baseline gap-3 font-display text-3xl tracking-tight text-ink';
const h2Num = 'font-display text-xl text-ink-faint';
const h3 = 'mt-8 text-[11px] uppercase tracking-[0.18em] text-ink-faint';
const text = 'mt-3 text-[15px] leading-7 text-ink-muted';
const list = 'mt-3 list-disc space-y-2 pl-5 text-[15px] leading-7 text-ink-muted marker:text-ink-faint';
const strong = '[&>li>strong]:text-ink [&_strong]:font-medium [&_strong]:text-ink';
const paramBlock = 'mt-6 border-l border-line pl-5';
const paramTitle = 'font-mono text-sm font-medium text-ink';

export default function AboutPage() {
    return (
        <div className="max-w-[68ch] space-y-16 pb-8">
            <section>
                <h2 className={h2}>
                    <span className={h2Num}>1.</span> Verificación general del código
                </h2>
            ...
            <section>
                <h2 className={h2}>
                    <span className={h2Num}>2.</span> Análisis detallado: Kalman Filter
                </h2>

                <h3 className={h3}>Explicación técnica</h3>
                <p className={text}>
                ...
                <h3 className={h3}>Analogía</h3>
                <p className={text}>Imagina que estás conduciendo un coche a ciegas en una carretera recta.</p>
                <ul className={`${list} ${strong}`}>
                ...
                <h3 className={h3}>Hiperparámetros</h3>

                <div className={paramBlock}>
                    <h4 className={paramTitle}>measurement_variance (R)</h4>
                    <p className={`${text} ${strong}`}><strong>Rango:</strong> (0,∞)</p>
                    <p className={`${text} ${strong}`}><strong>Función:</strong> Qué tan ruidoso es tu sensor (los datos que traes de la base de datos).</p>
                    <ul className={`${list} ${strong}`}>
                    ...
                    <p className={`${text} ${strong}`}><strong>En tu código:</strong> Default 10. Si tus datos (values) están en un rango de 0 a 100, esto es moderado. Si tus datos son de 0 a 1, esto es muchísimo ruido y el filtro casi no se moverá.</p>
                </div>

                <div className={paramBlock}>
                    <h4 className={paramTitle}>process_variance (Q)</h4>
                    <p className={`${text} ${strong}`}><strong>Rango:</strong> (0,∞)</p>
                    <p className={`${text} ${strong}`}><strong>Función:</strong> Qué tanto esperas que el sistema cambie de forma natural (su &quot;inquietud&quot;).</p>
                    <ul className={`${list} ${strong}`}>
                    ...
                    <p className={`${text} ${strong}`}><strong>Ajuste:</strong> Para suavizar, se busca un equilibrio donde Q sea menor que R, pero no tan pequeño que el filtro se &quot;congele&quot;.</p>
                </div>

                <div className={paramBlock}>
                    <h4 className={paramTitle}>initial_error (P)</h4>
                    <p className={`${text} ${strong}`}><strong>Rango:</strong> (0,∞)</p>
                    <p className={`${text} ${strong}`}><strong>Función:</strong> Incertidumbre inicial del estado.</p>
                    <p className={`${text} ${strong}`}><strong>Efecto:</strong> Muy alto al principio hace que el primer dato se tome como verdad absoluta. Con el paso de las iteraciones, este valor converge y deja de importar. Generalmente se deja en 1.0 o un valor alto.</p>
                </div>

                <div className={paramBlock}>
                    <h4 className={paramTitle}>transition_matrix (F)</h4>
                    <p className={`${text} ${strong}`}><strong>Rango:</strong> Cualquier flotante (usualmente 1.0).</p>
                    <p className={`${text} ${strong}`}><strong>Función:</strong> Define cómo evoluciona el estado. 1.0 significa &quot;creo que el valor futuro será igual al valor actual&quot; (Random Walk).</p>
                </div>
            </section>

            <section>
                <h2 className={h2}>
                    <span className={h2Num}>3.</span> Análisis detallado: Savitzky-Golay
                </h2>
                ...
                <h3 className={h3}>Analogía</h3>
                <p className={text}>Imagina que tienes una cadena de puntos en una mesa.</p>
                <ul className={list}>
                ...
                <div className={paramBlock}>
                    <h4 className={paramTitle}>window_length (Ventana)</h4>
                    <p className={`${text} ${strong}`}><strong>Rango:</strong> Entero impar positivo. polyorder &lt; window_length.</p>
                    <p className={`${text} ${strong}`}><strong>Función:</strong> Cuántos puntos vecinos considerar para suavizar un punto central.</p>
                    <ul className={`${list} ${strong}`}>
                    ...
                    <p className={`${text} ${strong}`}><strong>En tu código:</strong> Default 21. Si tu resolución es muy alta (muchos puntos cercanos), esto está bien. Si tienes pocos puntos, esto es demasiado grande.</p>
                </div>

                <div className={paramBlock}>
                    <h4 className={paramTitle}>polyorder (Orden del polinomio)</h4>
                    <p className={`${text} ${strong}`}><strong>Rango:</strong> Entero ≥0 y menor que window_length.</p>
                    <p className={`${text} ${strong}`}><strong>Función:</strong> Qué tan compleja es la curva que se ajusta (0 = línea plana/media, 1 = línea recta, 2 = parábola/curva, 3 = curva con inflexión).</p>
                    <ul className={`${list} ${strong}`}>
            ...
            <section>
                <h2 className={h2}>
                    <span className={h2Num}>4.</span> Análisis detallado: Whittaker (Eilers)
                </h2>
                ...
                <h3 className={h3}>Analogía</h3>
                <p className={text}>Imagina una elástica o una cuerda fina de goma.</p>
                <ul className={list}>
                ...
                <div className={paramBlock}>
                    <h4 className={paramTitle}>lmbd (Lambda)</h4>
                    <p className={`${text} ${strong}`}><strong>Rango:</strong> (0,∞) (A escala logarítmica).</p>
                    <p className={`${text} ${strong}`}><strong>Función:</strong> Parámetro de suavizado. Controla el equilibrio entre fidelidad a los datos y suavidad.</p>
                    <ul className={`${list} ${strong}`}>
                    ...
                    <p className={`${text} ${strong}`}><strong>Nota:</strong> Es el parámetro más crítico. A diferencia de Kalman, Whittaker suaviza toda la serie &quot;a la vez&quot;, por lo que no tiene lag (retraso); el pico ocurre exactamente donde debe ocurrir, solo que con forma más suave.</p>
                </div>

                <div className={paramBlock}>
                    <h4 className={paramTitle}>d (Orden de diferencia)</h4>
                    <p className={`${text} ${strong}`}><strong>Rango:</strong> Entero positivo (1, 2, 3...).</p>
                    <p className={`${text} ${strong}`}><strong>Función:</strong> Qué propiedad geométrica se penaliza.</p>
                    <ul className={`${list} ${strong}`}>
